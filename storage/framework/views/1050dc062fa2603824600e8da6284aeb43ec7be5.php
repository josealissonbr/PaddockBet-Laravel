        ...
        <div class="row">
                ...
                <div class="user-face">
                    <div class="part-left">
                        ...
                        <div class="part-name">
                            ...
                            <span class="user-name-text"><?php echo e(auth()->user()->nome); ?></span>
                        </div>
                    </div>
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="dashboard-menu">
                    <ul>
                        <li>
                            <a href="<?php echo e(route('dashboard')); ?>" class="menu-item <?php if(\Request::route()->getName() == "dashboard"): ?> active <?php endif; ?>">
                                Painel
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('dashboard.apostas')); ?>" class="menu-item <?php if(\Request::route()->getName() == "dashboard.apostas"): ?> active <?php endif; ?>">
                                Apostas
                            </a>
                        </li>
                        <li>
                            <a href="depositos.php" class="menu-item ">
                                Depósitos
                            </a>
                        </li>
                        <li>
...
<?php /**PATH /home/miller/envsandbox.millersistemas.com.br/Paddockbet/resources/views/layouts/header.blade.php ENDPATH**/ ?>