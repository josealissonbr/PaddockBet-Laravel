...
<html lang="zxx">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/dashboard-responsive.css')); ?>">
    </head>
    ...
    <body>
        ...
        <!-- preloader begin -->
        <div class="preloader">
            <img src="<?php echo e(asset('assets/img/preloader.gif')); ?>" alt="">
            <span><?php echo e(env('PaddockBet')); ?></span>
        </div>
        <!-- preloader end -->
                        ...
                        <div class="about-widget">
                            ...
                            <div class="support">
                                <ul>
                                    <li>
                                        <span class="icon">
                                            <img src="<?php echo e(asset('assets/img/svg/email.svg')); ?>" alt="">
                                        </span>
                                        <span class="text">
                                    ...
                                    <li>
                                        <span class="icon">
                                            <img src="<?php echo e(asset('assets/img/svg/phone-call.svg')); ?>" alt="">
                                        </span>
                                        <span class="text">
        ...
        <!-- filterizr js -->
        <script src="<?php echo e(asset('assets/js/jquery.filterizr.min.js')); ?>"></script>
        <!-- wow js-->
        <script src="<?php echo e(asset('assets/js/wow.min.js')); ?>"></script>
        <!-- clock js -->
        <script src="<?php echo e(asset('assets/js/clock.min.js')); ?>"></script>
        ...
        <script src="<?php echo e(asset('assets/js/chart-activate.js')); ?>"></script>
...
<?php /**PATH /home/miller/envsandbox.millersistemas.com.br/Paddockbet/resources/views/layouts/app.blade.php ENDPATH**/ ?>